...
#q = (1, 3, 4, 7, 12)        # 2nd pass solution is faster by:  ~79.3%
#q = set(range(1, 10))      # 2nd pass solution is faster by:  ~96.3%
q = set(range(1, 200))     # 2nd pass solution is faster by:  ~99.7%
